...
const Header = ({ theme, onThemeChange }) => {
  return (
    <header className="bg-element py-4 bg-transition position-relative shadow-element">
      <div className="container d-flex align-items-center justify-content-between">
        ...
        <button
          type="button"
          className="theme-btn btn text-color p-0 text-capitalize d-flex align-items-center gap-2"
