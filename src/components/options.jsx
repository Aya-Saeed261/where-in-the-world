...
const Options = ({ theme, onSearch, searchValue, onFilter, filterValue }) => {
  ...
  return (
    <form
      className="row m-0 justify-content-between align-items-center gap-4 mb-3 mb-sm-4 mb-md-5 pb-3 pb-md-0 px-2 px-md-0"
    ...
    >
      ...
      <div className="col-7 col-md-4 col-lg-3 col-xl-2 px-0 ps-md-5 ps-lg-4 position-relative">
        ...
        <ul className="dropdown-menu bg-element shadow-element d-block">
          {regions.map((region) => (
            <li key={region.id}>
              <button
                type="button"
